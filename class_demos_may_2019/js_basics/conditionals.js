...
if (mood === 'happy') {
	...
	// this will never run since a prior if statement will always evaluate
	// to true before it
...
// to copy a line press shift+alt+down arrow
false ? console.log('It was truthy') : console.log('it was falsy');
5 > 10 ? console.log('It is bigger than 10') : console.log('it is not bigger than 10');
const size = 180; // represents a size in cm
const large = 190; // represents a large size in cm
size > large ? console.log('They are tall') : console.log('They are small');